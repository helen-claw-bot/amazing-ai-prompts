...
> 团队：2人小工作室
> 
> 设备1：WIN11, i7 Intel 64bit CPU, 32GB RAM, NVIDIA RTX3060 12GB, 500GB SSD
> 
> 设备2：MacBook Air M2 16GB（无独立显卡）
...
| # | 需求 | 目标 | 推荐工具 |
|---|------|------|---------|
| 1 | **真人换脸/换头到AI角色图** | 把授权模特的脸注入到定妆照中，实现"这就是这个角色的样子" | ?? |
| 1 | **真人换装** | 把底图的人物服装换成不同的，完成定妆照 | ?? |
| 2 | **角色一致性验证** | 同一个角色在不同镜头/场景中保持五官、服装、气质统一 | ?? |
